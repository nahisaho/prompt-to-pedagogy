...
| 03 | Analysis | 学習者分析 | 公開 |
| 04 | Analysis | タスク分析 | 公開 |
| 05 | Analysis | 環境・制約分析 | 公開 |
| 06 | Design   | 逆向き設計 | 公開 |
| 07 | Design   | ルーブリックの共同設計 | 公開 |
| 08 | Design   | 授業構造 (Gagné × Merrill) | 公開 |
| 09 | Development | 教材ドラフトと査読ループ | 公開 |
| 10 | Development | 差異化と多モダリティ | 公開 |
| 11 | Development | プロンプト・パターンカタログ | 公開 |
| 12 | Implementation | 授業前リハーサル | 公開 |
| 13 | Implementation | 授業中の AI ファシリテーション | 公開 |
| 14 | Evaluation | 形成的評価 | 公開 |
| 15 | Evaluation | 総括的評価とポートフォリオ | 公開 |
| 16 | Evaluation | プログラム評価と次サイクル | 公開 |
| 17 | ふりかえり | 佐藤先生の 1 年後 | 公開 |

### 8.1 通し rubber-duck レビュー & Fact Check の反映 (2026-07-12)

全 17 章に対して 5 並列の rubber-duck レビューを実施し、Blocking / Non-Blocking /
Suggestion 級の指摘をすべて反映済み。主な修正:

- **Ch3:** クラスタ C7 の役割整理 (「表現多様性志向」を維持)
- **Ch4:** Mager の 3 要素 (Performance/Conditions/Criterion) を正確化、
  Bloom 階層性の注釈、Gagné 5 分類と 9 events の区別を追加
- **Ch7:** Andrade (2000) を rubric = 学習の道具の根拠として本文に統合
- **Ch8:** Gagné 9 事象の日本語ラベルを正式版に修正、Vygotsky ZPD /
  Wood-Bruner-Ross scaffolding への系譜注記を追加
- **Ch9:** 30 分ドラフトの理論根拠を Kirkpatrick から Rapid Prototyping
  (Tripp & Bichelmeyer 1990) に変更
- **Ch10:** CAST UDL の "Multiple Means of Representation" の誤訳修正
  (「表現手段」→「情報提示・表象」)、3 原則を正確に配置
- **Ch12:** Cognitive Apprenticeship の 4 要素
  (Modeling/Coaching/Scaffolding & Fading/Articulation) を明示し、
  本章 = Modeling、第13-15回で残り 3 要素が回収される位置づけを追加
- **Ch13:** JiTT (Novak et al. 1999) の定義と、「バックステージ AI」が
  JiTT そのものではなく応用である旨を明記
- **Ch14:** Assessment OF/FOR/AS Learning の 3 分類を Earl (2003) /
  Manitoba Education (2006) に帰属、Black & Wiliam の役割を分離
- **Ch15:** Paulson et al. (1991) ポートフォリオ定義 + Wiggins (1998)
  Educative Assessment の 2 つの系譜を明記
- **Ch16:** Kirkpatrick 1994 書籍化を明記
- **Ch17:** -A/-T は NERIS 独自要素、再テスト信頼性、MI 微増の因果表現を
  仮説へ緩和
- **shared/references.md:** Earl 2003, Andrade 2000, Tripp-Bichelmeyer 1990,
  Allen-Ryan 1969, Novak 1999, Kirkpatrick 1994, Paulson 1991, Wiggins 1998,
  Black-Wiliam "Inside the Black Box" を追加
...
## 付録: 特別編 (Special Series)

本編 17 回とは別軸で、校務・働き方など隣接テーマを扱う特別編。
...
- 本編が「授業設計に AI をどう使うか」を扱うのに対し、S1 は
  **授業以外の校務・働き方に AI をどう組み込むか** を扱う
