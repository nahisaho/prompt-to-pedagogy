...
各記事から共通に参照する主要文献のリスト。記事側では
`[Bloom 1956](../../shared/references.md#bloom-1956)` のように相対リンクで参照する。
...
- <a id="paulson-1991"></a>Paulson, F. L., Paulson, P. R., & Meyer, C. A. (1991). What Makes a Portfolio a Portfolio? *Educational Leadership*, 48(5), 60–63.
- <a id="wiggins-1998"></a>Wiggins, G. (1998). *Educative Assessment: Designing Assessments to Inform and Improve Student Performance*. Jossey-Bass.

## プロンプト設計・LLM (Prompt Engineering & LLM)

- <a id="brown-2020"></a>Brown, T. B. et al. (2020). Language Models are Few-Shot Learners. *NeurIPS*.
- <a id="wei-2022"></a>Wei, J. et al. (2022). Chain-of-Thought Prompting Elicits Reasoning in Large Language Models. *NeurIPS*.
- <a id="kojima-2022"></a>Kojima, T. et al. (2022). Large Language Models are Zero-Shot Reasoners. *NeurIPS*.
- <a id="white-2023"></a>White, J. et al. (2023). A Prompt Pattern Catalog to Enhance Prompt Engineering with ChatGPT. *arXiv:2302.11382*.
...
- <a id="branch-2009-placeholder"></a>Branch, R. M. (2009). *Instructional Design: The ADDIE Approach*. Springer.
- <a id="shulman-1986-placeholder"></a>Shulman, L. S. (1986). Those Who Understand: Knowledge Growth in Teaching. *Educational Researcher*, 15(2), 4–14.
- <a id="kolb-1984-placeholder"></a>Kolb, D. A. (1984). *Experiential Learning: Experience as the Source of Learning and Development*. Prentice Hall.
- <a id="guskey-2002-placeholder"></a>Guskey, T. R. (2002). Professional Development and Teacher Change. *Teachers and Teaching*, 8(3), 381–391.
- <a id="reigeluth-1999-placeholder"></a>Reigeluth, C. M. (Ed.). (1999). *Instructional-Design Theories and Models, Volume II: A New Paradigm of Instructional Theory*. Lawrence Erlbaum.
- <a id="allen-2012-placeholder"></a>Allen, M. W. (2012). *Leaving ADDIE for SAM: An Agile Model for Developing the Best Learning Experiences*. ASTD Press.
- <a id="merrill-2002-placeholder"></a>Merrill, M. D. (2002). First Principles of Instruction. *Educational Technology Research and Development*, 50(3), 43–59.
